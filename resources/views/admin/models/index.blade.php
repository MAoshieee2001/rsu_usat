...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-search"></i> Listado de Modelos</h3>
    ...
    <script>
        ...
        $('#btnNuevo').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('.modal-title').html("<i class='fas fa-plus'></i> Nuevo modelo");
        ...
        $(document).on('click', '.btnEditar', function () {
            ...
            $.ajax({
                ...
                type: "GET",
                success: function (response) {
                    $('.modal-title').html("<i class='fas fa-edit'></i> Editar Modelo");
                    $('#ModalCenter .modal-body').html(response);
                    $('#ModalCenter').modal('show');
