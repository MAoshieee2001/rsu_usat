...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-search"></i> Listado de Funciones</h3>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">
        ...
        <a href="{{ route('admin.employeetypes.index') }}" class="btn btn-success"><i class="fas fa-sync"></i>
            Actualizar</a>
    </div>
</div>
...
@section('js')
    <script>
        ...
        $('#btnNuevo').click(function () {
            $.ajax({
                ...
                success: function (response) {
                    $('.modal-title').html("<i class='fas fa-plus'></i> Nueva Función");
        ...
        $(document).on('click', '.btnEditar', function () {
            var id = $(this).attr("id");
            $.ajax({
                url: "{{ route('admin.employeetypes.edit', 'id') }}".replace('id', id),
                type: "GET",
                success: function (response) {
                    $('.modal-title').html("<i class='fas fa-edit'></i> Editar Función");
                    $('#ModalCenter .modal-body').html(response);
                    $('#ModalCenter').modal('show');
