...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-search"></i> Lista de horarios</h3>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('admin.schedules.index') }}" class="btn btn-success">
        ...
        $('#btnNuevo').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('.modal-title').html("<i class='fas fa-plus'></i>  Nuevo Horario");
